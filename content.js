(function () {
  ...
  const TEXT_MAP = [
    [/\bSubscribe\b/gi, 'TRACK TARGET'],
    [/\bSubscribed\b/gi, 'TRACKING'],
    [/\bUnsubscribe\b/gi, 'CEASE TRACKING'],
    [/\bLike\b/gi, 'CONFIRM SIGNAL'],
    [/\bDislike\b/gi, 'REJECT SIGNAL'],
    [/\bShare\b/gi, 'DISTRIBUTE INTEL'],
    [/\bComment\b/gi, 'FIELD REPORT'],
    [/\bComments\b/gi, 'FIELD REPORTS'],
    [/\bRecommended\b/gi, 'RELATED ACTIVITY'],
    [/\bTrending\b/gi, 'HIGH ACTIVITY'],
    [/\bLive\b/gi, 'LIVE FEED'],
    [/\bWatch later\b/gi, 'FLAG FOR REVIEW'],
    [/\bHistory\b/gi, 'ACTIVITY LOG'],
    [/\bLibrary\b/gi, 'INTEL ARCHIVE'],
    [/\bHome\b/gi, 'COMMAND CENTER'],
    [/\bExplore\b/gi, 'SCAN PERIMETER'],
    [/\bShorts\b/gi, 'MICRO FEEDS'],
    [/\bPlaylist\b/gi, 'OPERATION FILE'],
    [/\bPlaylists\b/gi, 'OPERATION FILES'],
    [/\bChannel\b/gi, 'SUBJECT PROFILE'],
    [/\bchannels\b/gi, 'SUBJECT PROFILES'],
    [/\bNotifications?\b/gi, 'ALERTS'],
    [/\bSearch\b/gi, 'SCAN DATABASE'],
    [/\bSave\b/gi, 'ARCHIVE'],
    [/\bDownload\b/gi, 'EXTRACT DATA'],
    [/\bReport\b/gi, 'FLAG INCIDENT'],
    [/\bSettings\b/gi, 'SYSTEM CONFIG'],
    [/\bviews\b/gi, 'OBSERVATIONS'],
    [/\bView\b/gi, 'OBSERVATION'],
    [/\bago\b/gi, 'ELAPSED'],
    [/\bsubscribers?\b/gi, 'OPERATIVES'],
    [/\bvideos?\b/gi, 'FEEDS'],
  ];
